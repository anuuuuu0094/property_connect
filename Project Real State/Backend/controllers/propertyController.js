...
//       return res.status(403).json({ message: "Only sellers or agents can list properties" });
//     }

//     const property = await Property.create({
//       ...req.body,
//       seller: userId, // logged-in seller is seller
//     });
...
//   try {
//     const filters = {};
//     const { city, state, country, listingType, propertyName, minPrice, maxPrice } = req.query;
...
// // Update property (only seller or agent)
...
//     if (String(property.seller) !== String(userId) && String(property.agent) !== String(userId)) {
...
//       return res.status(403).json({ message: "Only the seller can delete this property" });
//     }
